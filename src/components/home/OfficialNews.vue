            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="(Array,index) in Arrays" :key="index">
                <div class="s1">
                  ...
                  <div class="right">
                    <h3>Coinw停机维护公告</h3>
                    <p>尊敬的用户您好：COINW将于2018年1月24日20点停机维护90分钟，维护内容如下：1、升级服务器性能；2、提高APP稳定性。请用户提前做好准备，给您带来不便请谅解！     Coinw  International team 2018.1.24...</p>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  export default {
    ...
    methods:{
      titleNewsChange(text){
        this.titleNewsText = text
      }
    },
    mounted(){
      let mySwiper = new Swiper('.News-swiper-container', {
  ...
  .office-news{
    ...
    .center{
      ...
      .left-img{
        width: 925px;
        height: 535px;
        background: url("/static/img/bg-index-03.jpg");
