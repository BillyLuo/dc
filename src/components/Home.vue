<template>
  <div class="home-index">
      ...
      <div class="wrapper">
        <div class="banner1">
          <div class="banner1-title">
            <h3 class="color-yellow text-center">超算网-超级算力交易网络</h3>
            <p class="color-white text-right">一场算力世界的民主革命</p>
          </div>
        </div>
      </div>
      ...
      <div class="wrapper">
          ...
          <Row>
            <Col :md="8" :sm="12">
              ...
              <p>
                ZeusNet链为供需双方构建信任平台，实现计算资源的快速撮合。通过智能合约和ZNC（ZeusNet Token）实现交易的安全、快速执行。
              </p>
            </Col>
            <Col :md="8" :sm="12">
    ...
    <section class="section2">
      <Row class="">
        <Col :sm="12" :xs="24" :class="'bg-yellow'">
          <div class="section-left">
            <h3>供求方</h3>
            <h5>What is BAIC</h5>
            <p>
              企业和终端用户都需要一个更强大、更灵活、更实惠、更快递的网络服务支持。
            </p>
          </div>
        </Col>
        <Col :sm="12" :xs="24" class="bg-494A4B">
          <div class="section-right">
            <h3 class="color-yellow">需求方</h3>
            <h5 style="color:C9BD53;">What is BAIC</h5>
    ...
    <section class="section4">
      <div class="wrapper">
        <h6>ZeusNet的血液</h6>
        <h3>ZNC (ZeusNet Coin)</h3>
        <h6>ZeusNet生态中的Token</h6>
        <p style="padding-top: 30px;">
          ZNC是驱动ZeusNet生态运转、价值传递的安全媒介，数字信用的可靠凭证，ZNC的商业用途主要用于ZeusNet链上各商业应用的交易支付：如算力交易、广告费、平台使用费、交易手续费等。
        </p>
        <p style="padding-top: 30px;">记账者负责记账和撮合交易、调度及仲裁，并获取相应ZNC作为激励</p>
          <p>算力提供者通过算力资源输出获得ZNC作为报酬</p>
          <p>基于算力网络的DAPP开发者从使用者手中获得ZNC作为使用服务费</p>
          <p>DApp使用者通过支付ZNC获得便宜的算力资源完成相应的共享应用服务
        </p>
      </div>
    </section>
    <Earnings />
    ...
    <section class="section7" id="team">
      <div class="wrapper">
    ...
    <section class="section8" id="route-map">
      <div class="wrapper">
...
.hexagon:before {
  ...
  border-bottom: 24px solid #2d2e2f;
}
.hexagon:after {
  content: "";
  position: absolute;
